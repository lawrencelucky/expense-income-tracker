...
const rightIcon = () => (
    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M8.29286 6.79289C7.90234 7.18342 7.90234 7.81658 8.29286 8.20711L12.5858 12.5L8.29286 16.7929C7.90234 17.1834 7.90234 17.8166 8.29286 18.2071C8.68339 18.5976 9.31655 18.5976 9.70708 18.2071L15.4142 12.5L9.70708 6.79289C9.31655 6.40237 8.68339 6.40237 8.29286 6.79289Z"
            fill="#BABDCC"
        />
    </svg>
);
    ...
    <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
            <clipPath id="clip0_1_3275">
                <rect width="14" height="14" fill="white" transform="translate(0.166687)" />
            </clipPath>
        </defs>
    </svg>
);
...
const arrowDown = () => (
    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            d="M2.98449 4.5H9.01496C9.43214 4.5 9.64074 5.00391 9.34543 5.29922L6.33136 8.31562C6.14855 8.49844 5.85089 8.49844 5.66808 8.31562L2.65402 5.29922C2.35871 5.00391 2.5673 4.5 2.98449 4.5Z"
            fill="#A0A0AB"
        />
    </svg>
);
