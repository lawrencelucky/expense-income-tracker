...
const SetUpResetPinForm = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: ({ pin }, { setSubmitting }) => {
            router.push({
                pathname: constants.CLIENT_ROUTES.auth.confirmResetPin,
                query: { pin },
            });
            setSubmitting(false);
        },
    ...
    return (
        <div className="bg-novelwhite py-8 px-4 w-[368px] border-novelgray-60 shadow-10 rounded-3xl">
            <div className="flex flex-col items-center">
                ...
                <Typography.Text className="font-bold text-lg block mb-1">Enter new pin</Typography.Text>
                <Typography.Text className="text-novelblack-20 block mb-6">
                    Enter your new pin to access your dashbaord
                </Typography.Text>
            </div>
...
export default SetUpResetPinForm;
