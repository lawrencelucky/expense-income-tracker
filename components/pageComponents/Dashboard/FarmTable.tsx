...
import EmptyStateProfileFarm from '../Profile/EmptyStateProfileFarm';
...
const FarmTable: React.FC = () => {
    ...
    console.log(farmsData?.data, 'FARMS DATA DOT DATA');
                ...
                <div className="rounded-2xl overflow-hidden no-scrollbar">
                    <AntdTable
                        ...
                        pagination={{
                            ...
                            pageSize: 10,
                            simple: true,
                            total: farmsData?.data?.totalRows,
                        }}
                        className="no-scrollbar shadow-70"
                    />
